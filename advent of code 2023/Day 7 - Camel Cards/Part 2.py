...
for i in range(len(ranking)):
    ...
    for j in range(1,len(ranking)-i):
        ...
        hand1_jokers = hand1_result[0]
        hand2_jokers = hand2_result[0]
        hand1_result.pop(0)
        hand2_result.pop(0)

        hand1_result[hand1_result.index(max(hand1_result))] += hand1_jokers
        hand2_result[hand2_result.index(max(hand2_result))] += hand2_jokers
